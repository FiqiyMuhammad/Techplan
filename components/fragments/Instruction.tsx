    ...
    <section id="instruction" className="instruction bg-white pt-12 md:pt-24 pb-4 overflow-hidden">
      <div className="container mx-auto px-8">
        <SectionHeader 
          ...
          title="One Unified System To Build AI Curricula And Automate Global Institutional Workflows Now"
          description="Designed to help users move from complex processes to a connected institutional flow — bringing clarity, automation, and system-level visibility into prompt-based curriculum design, smart scheduling, and automated flows now."
        />
      </div>
      
      <div className="circuit-container relative w-full h-[320px] md:h-[550px] overflow-hidden">
        {/* Fade edges */}
          ...
          <div id="obj-1" className="obj flex flex-col items-center justify-center p-2 md:p-4">
            <div className="obj-inner relative group transition-transform duration-500 hover:scale-105">
              <Image 
                ...
                width={80}
                height={100}
                className="w-[60px] md:w-[120px] h-auto drop-shadow-2xl"
              />
            </div>
          </div>

          <div id="obj-2" className="obj flex flex-col items-center justify-center p-2 md:p-4">
            <div className="obj-inner relative w-[140px] h-[140px] md:w-[280px] md:h-[280px] flex items-center justify-center scale-90 md:scale-100">
               {/* Outer Glow */}
               ...
               {/* White Layer (Gap) */}
               <div className="absolute inset-[15px] md:inset-[30px] rounded-full bg-white shadow-xl z-10"></div>
               
               {/* Center Gradient with Icon (User Specified Blue) */}
               <div className="absolute inset-[25px] md:inset-[45px] rounded-full bg-gradient-to-br from-[#368AE3] to-[#3B9AF7] flex items-center justify-center z-20 shadow-inner">
                 <Image 
                   src="/logoku/logo2/logo-aja2.svg" 
                   alt="TechPlan Logo" 
                   width={60} 
                   height={60}
                   className="w-[40px] md:w-[130px] brightness-0 invert drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]"
                 />
               </div>
            </div>
          </div>
