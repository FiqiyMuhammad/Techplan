...
export default function Hero() {
  ...
  return (
    <header id="home" className="relative min-h-[85vh] flex items-center justify-center pt-[140px] pb-[100px] text-center overflow-hidden">
      ...
      >
        {/* Headline */}
        <h1 className="hero-title text-[1.85rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] leading-[1.15] md:leading-[1.1] mb-8 tracking-[-0.03em] font-semibold font-aspekta py-2 text-balance">
          <motion.span 
            variants={itemVariants}
            className="bg-gradient-to-r from-black from-[45%] to-[#3A96F6] bg-clip-text text-transparent inline-block pb-0.5 md:pb-1"
          >
            Design Curriculum.
          </motion.span> <br />
          <motion.span 
